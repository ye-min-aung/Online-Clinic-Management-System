      ...
      <div class="hero-section">
        <div class="" style="width: 100%;">
          <div class="container mt-5 col-md-6 col-lg-4 shadow p-5 mb-5  rounded " >
             ...
             <form action="/ClinicManagementSystem/Reception/receptionChangePassword" method="post" class=" "style="font-family: 'Asar';font-size: 17px;">
             	<h3 style="text-align: center;">Update Password</h3>
             <div class="row ">
              <% 
				HttpSession ss = request.getSession();
 			    String receptionId = (String) ss.getAttribute("receptionId");
  				if(receptionId != null){
             ...
             <div class="mb-3 col-12 ">
	                  ...
	                  <input type="text" class="form-control bginput" name="reception_password" value="<%= password %>" required autocomplete="off">
              </div>
            
              <div class="mb-3 col-12">
                <label class="form-label">Change Password</label>
                
                  <input type="password" class="form-control bginput" name="reception_newpassword" placeholder="Enter change password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one lowercase letter, one uppercase letter, and at least 8 characters">
...
<script type="text/javascript">
 function togglePasswordVisibility() {
	  ...
	  var passwordInput = document.getElementById("reception_password");
