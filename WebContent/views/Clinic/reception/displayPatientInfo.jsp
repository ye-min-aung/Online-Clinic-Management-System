...
<head>
  ...
  <title> Reception Patient Information</title>
<style>
	table {
...
<body>
 ...
 <center><h3>Patient Information</h3></center><br>
 	...
 	<div class="d-flex justify-content-center">   
       <form action="/ClinicManagementSystem/Reception/viewPatientList" method="post" class="d-flex " style="float:left">
           <input class="form-control me-2" type="search" placeholder="Search Patients" name="searchName" aria-label="Search" style="width: 300px;">
           <button class=" btn btn-success  me-3" type="submit">Search</button>
       </form>
       <form action="/ClinicManagementSystem/Reception/viewPatientList" method="get" style="float:left">
