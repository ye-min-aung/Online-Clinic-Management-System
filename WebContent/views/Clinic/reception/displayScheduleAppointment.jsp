...
<head>
  ...
  <title>Reception Schedule Appointment</title>
<style>
	table {
...
<body>
  ...
  <center><h3>Schedule Lists</h3></center><br>
...
>
   ...
   <div class="d-flex justify-content-center">  
	<form action="/ClinicManagementSystem/Appointment/replySchedule" method="get" class="d-flex " style="float:left">
           <input class="form-control me-2" type="date" placeholder="Search Date" name="searchName" aria-label="Search" style="width: 300px;">
           <button class="btn btn-success me-3" type="submit">Search</button>
       </form>
       <form action="/ClinicManagementSystem/Appointment/scheduleAppointment" method="get" style="float:left">
  ...
  <br><br>
 	<table  style="width:95%;" class="ms-4">
			...
			<%
				...
				ArrayList<Appointment> appInfo = (ArrayList<Appointment>)ss.getAttribute("appointList");
			...
			<tr>
				...
				<td> <%=a.getDoctor_name()%> </td>
				<td> <%=a.getStatus()%> </td>
				<td> <%=a.getReception_name()%> </td>
				<td class="text-center"> 
				 <form action="/ClinicManagementSystem/Appointment/scheduleAppointment" method="post" style="display: inline;">
  					<input type="hidden" name="appointment_id" value="<%= a.getAppointment_id() %>">
                      <button type="submit" class="btn btn-success btn-sm" name="access">Accept</button>
                    </form>
                    <form action="/ClinicManagementSystem/Appointment/replySchedule" method="POST" style="display: inline;">
                      <input type="hidden" name="appointment_id" value="<%= a.getAppointment_id() %>">
                          <input type="hidden" name="reply" value="true">
                      <button type="submit" class="btn btn-success btn-sm bg-danger " name="reply">Reply</button>
                    </form>
				 </td>	
			</tr>
				<%
