...
<meta charset="UTF-8">
  ...
  <title>Reception Update Profile</title>
<style>
     *{
  margin: 0;
      ...
      <div class="hero-section">
        <div class="" style="width: 100%;">
          <div class="container mt-5  col-md-6 col-lg-5 shadow p-4 mb-5  rounded " >
            ...
            <form action="/ClinicManagementSystem/Reception/receptionUpdateProfile" method="post" class=" "style="font-family: 'Asar';font-size: 17px;">
             ...
             <% 
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                  ...
                  <input type="text" class="form-control bginput" name="reception_gender" value="<%= gender %>" required readonly>
                </div>

				<!--  <div class=" col-12 col-md-6">
                  <label class="form-label">Gender</label>
                  
                    <select class="form-select bginput" name="reception_gender" required disabled>
