...
<head>
    ...
    <title>Admin(Monthly Income)</title>
    <style>
*{
  margin: 0;
...
%>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link me-3" href="/ClinicManagementSystem/dailyReport" style="color:black">Daily</a>
      </li>
	<li class="nav-item">
        <a class="nav-link me-3" href="/ClinicManagementSystem/monthlyReport" style="color:black ;padding :10px 20px;background-color: #d8f8f6;border-radius:13px 2px;"">Monthly</a>
      </li>
	<li class="nav-item">
    ...
    <div class="hero-section">
    	<div class="d-flex justify-content-center mb-5" >
    		<form action="/ClinicManagementSystem/monthlyReport" method="get" class="d-flex " style="float:left">
            	<label for="searchMonth" class="mt-2 me-3">Select Year:</label>
             	<input type="text" class="form-control" id="year" name="year" placeholder="YYYY" class="form-control me-2 "  style="width: 300px;">
            	<button type="submit" class="btn btn-success mx-3">Search</button>
        	</form>
        
        	<form action="/ClinicManagementSystem/monthlyReport" method="get" style="float:left" >
        ...
        <tr class="bg-success text-white">
            <th>Date</th>
            <th>Monthly Patients</th>
            <th>Total Income</th>
        </tr>
<%
				HttpSession ss = request.getSession();

				ArrayList<MonthlyReport> monthlyReports = (ArrayList<MonthlyReport>)ss.getAttribute("monthlyReports");

				 for(MonthlyReport a : monthlyReports){
			%>
	<tr  class="table-light text-center">
	<td> <%= a.getMonth()%> </td>
	<td> <%=a.getTotalPatients()%> </td>
