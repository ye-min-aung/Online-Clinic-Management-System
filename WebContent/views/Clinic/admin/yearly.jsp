...
<head>
    ...
    <title>Admin(Yearly Income)</title>
    <style>
*{
  margin: 0;
...
%>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<li class="nav-item px-2">
        <a class="nav-link me-3 " href="/ClinicManagementSystem/yearlyReport" style="color:black;padding :10px 20px;background-color: #d8f8f6;border-radius:13px 2px;">Yearly</a>
      </li>
    </ul>
  </div>
</nav>
    ...
    <div class="hero-section">
          ...
          <table  class="mt-5" style="width:80%;margin-left:140px">
        <tr class="bg-success text-white" >
            <th>Date</th>
            <th>Yearly Patients</th>
            <th>Total Income</th>
        </tr>
<%
				HttpSession ss = request.getSession();

				ArrayList<Report> yearlyReports = (ArrayList<Report>)ss.getAttribute("yearlyReports");

				 for(Report a : yearlyReports){
			%>
