...
%>
  ...
  <nav class="navbar navbar-expand-lg bg-success " style="font-size:16px;padding-left:76px;border-bottom: 2px solid rgba(73, 117, 214, 0.505) ;">
  <div class="collapse navbar-collapse " id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      <li class="nav-item">
        <a class="nav-link icomhover me-3" href="/ClinicManagementSystem/dailyReport" >Daily</a>
      </li>
	<li class="nav-item">
        <a class="nav-link icomhover me-3" href="/ClinicManagementSystem/monthlyReport">Monthly</a>
      </li>
	<li class="nav-item">
        <a class="nav-link icomhover me-3" href="/ClinicManagementSystem/yearlyReport" >Yearly</a>
      </li>
    </ul>
  </div>
</nav>
