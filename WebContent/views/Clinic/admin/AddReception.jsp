...
<head>
  ...
  <title>Admin(Add Reception)</title>
  <style>
*{
margin: 0;
...
%>
    ...
    <div class="hero-section">
      <div class="" style="width: 100%;">
        <h2 style="text-align: center;">Add Reception</h2>
        <div class="container mt-5 col-md-6 col-lg-5 shadow p-5 mb-5  rounded " >
        
          <form action="/ClinicManagementSystem/admin/create_reception" method="post">
          
            <div class="mb-3 row">
              <label class="col-sm-5 col-form-label">Reception Name</label>
              <div class="col-sm-6">
                <input type="text" class="form-control bginput" name="reception_name" placeholder="Enter Name" required>
              </div>
            </div>
            <div class="mb-3 row">
              <label  class="col-sm-5 col-form-label"> Address</label>
              <div class="col-sm-6">
                <input type="text" class="form-control bginput" name="reception_address" placeholder="Enter Address" required>
              </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-6">
                   <input type="date" class="form-control bginput" name="reception_birth_date" required>
              </div>
            </div>
            <div class="mb-3 row">
              <label class="col-sm-5 col-form-label">Password</label>
              <div class="col-sm-6">
                <input type="password"  class="form-control bginput" name="reception_password" placeholder="Enter Password" required>
              </div>
              <br>
              <%
            ...
            <div class="mb-4 text-center ">
                <button type="submit" class="btn btn-success ">Add Reception</button>
