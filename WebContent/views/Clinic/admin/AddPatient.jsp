     ...
     <div class="hero-section">
      <div class="container mt-5">
        ...
        <div class="row justify-content-center">
          ...
          <form class="mt-3 mb-3 " action="/ClinicManagementSystem/patient" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control bginput" name="patient_password" placeholder="Enter Password"    required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control bginput" name="patient_contact_no" placeholder="094556578"  required autocomplete="off">
            </div>
