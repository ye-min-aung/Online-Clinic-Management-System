     ...
     <div class="container mt-2">
        ...
        <div class="row justify-content-center">
          <div class="col-md-8 shadow p-5 rounded">
			<form action="/ClinicManagementSystem/admin/doctor" method="post" enctype="multipart/form-data">
            <div class="d-flex mb-3">
              <div class="w-50 me-3">
                ...
                <div class="w-50">
                  ...
                  <input type="text" class="form-control bginput" name="doctor_qualification" required placeholder="Enter Qualification">
                </div>
            </div>
            <div class="d-flex mb-3">
                <div class="w-50 me-3">
                  ...
                  <div class="col-sm-6 w-100">
                    <select name="doctor_gender" class="form-select bginput" required>
            ...
            <div class="d-flex mb-3 ">
                ...
                <div class="w-50">
                  ...
                  <input type="text" class="form-control bginput" name="doctor_address" placeholder="Enter Doctor Address" required>  
                </div>
            </div>
            <div class="d-flex mb-3">
                <div class="w-50 me-3">
                ...
                <div class="w-50">
                    ...
                    <input type="number" class="form-control bginput" name="year_of_experience" placeholder="Enter Year of Experience" required pattern="[0-9]+" title="Please enter a valid number for Year of Experience">
                </div>
            </div>
            <div class="d-flex mb-3">
                <div class="w-50 me-3">
           ...
           <div class="d-flex mb-3">
            <div class="w-50 me-3">
		        ...
		        <input type="file" class="form-control bginput" name="doctor_image" accept="image/*"> 
    </div>
    </div>
