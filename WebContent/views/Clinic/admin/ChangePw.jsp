   ...
   <div class="hero-section">
        <div class="" style="width: 100%;">
          <div class="container mt-5 col-md-6 col-lg-4 shadow p-5 mb-5  rounded " >
            <form action="/ClinicManagementSystem/Admin/adminChangePassword" method="post" class=" "style="font-family: 'Asar';font-size: 17px;">
             ...
             <div class="row ">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control bginput" name="admin_password" value="<%= password %>" required autocomplete="off">
              </div>
              <div class="mb-3">
                <label class="form-label ">New Password</label>
                <input type="password" class="form-control bginput" name="admin_newPassword" placeholder="Enter New Password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one lowercase letter, one uppercase letter, and at least 8 characters" >
              </div>
              <% 
      }
  }
