...
%>
        ...
        <form action="/ClinicManagementSystem/Admin/adminUpdateProfile" method="post" class=" "style="font-family: 'Asar';font-size: 17px;">
            <h3 style="text-align: center;">Update Profile</h3>                
              <div class="row ">
          <% 
				HttpSession ss = request.getSession();
 			    String adminId = (String) ss.getAttribute("adminId");
  				if(adminId != null){
				      ...
				      if (rs.next()) {
				        ...
				        String contact = rs.getString("admin_contact_no");
				        String address = rs.getString("admin_address");
				%>
          <div class="mb-3 row">
            <label class="col-sm-5 col-form-label">Admin Name</label>
            <div class="col-sm-6">
              <input type="text" class="form-control bginput" name="admin_name" value="<%= name %>" required pattern="[A-Za-z\s]+$" autocomplete="off">
            </div>
          </div> 
          <div class="mb-3 row">
            <label class="col-sm-5 col-form-label">Password</label>
            <div class="col-sm-6">
              <input type="text" class="form-control bginput" name="admin_password" value="<%= password %>" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one lowercase letter, one uppercase letter, and at least 8 characters" autocomplete="off">
            </div>
          </div> 
          <div class="mb-3 row">
            <label class="col-sm-5 col-form-label">Contact Number</label>
            <div class="col-sm-6">
              <input type="text" class="form-control bginput" name="admin_contact_no" value="<%= contact %>" required autocomplete="off">
            </div>
          </div> 
          <div class="mb-3 row">
            <label class="col-sm-5 col-form-label">Address</label>
            <div class="col-sm-6">
              <input type="text" class="form-control bginput" name="admin_address" value="<%= address %>" required autocomplete="off">
            </div>
          </div> 
           <% 
      }
