	...
	<div class="container mt-5">
        <div class="row mt-5 " >
            <div class="col-12 col-md-3   p-md-2" style="text-align: center;background-color: rgba(255, 255, 255, 0.491);">
				<div class=" " style="background-color: #b9aeae70;">
					<img src="${pageContext.request.contextPath}/uploads/${requestScope.dImage}" width="210px" height="200px">
				</div>       
			</div>
          ...
          <h3 class="text-primary">${requestScope.dName}</h3>
           <p><strong>-The best doctor at least ${requestScope.dExp} years on ground experience.</strong></p>
