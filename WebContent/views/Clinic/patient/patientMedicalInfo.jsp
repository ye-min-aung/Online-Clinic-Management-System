...
<a class="nav-link text-dark address" href="/ClinicManagementSystem/Patient/patientDoctorList">DOCTOR LIST</a>
            ...
            <input type="hidden" name="patient_id" value="<%= patientId%>">
              <button id="App" style="border:none; background-color: rgba(43, 187, 240, 0.02);">MEDICAL INFO</button>
              </form>
               </a>
            </li>
            <!-- medicalINof -->
...
<!--SLIde IMG-->
 ...
 <div class="hero-section">
 		 <center><h2>Invoice Details</h2></center><br>
        ...
        <table class="table table-bordered ms-4 " style="width:95%;">
          ...
          ArrayList<Invoice> invoice = (ArrayList<Invoice>) session.getAttribute("invoice");
    ...
    <%
        ...
        ArrayList<MedicalRecord> medicalRecord = (ArrayList<MedicalRecord>) session.getAttribute("medicalRecord");
    %>
   
    <br><br> <br><center><h2>Medical Records</h2></center><br>
      <table class="table table-bordered ms-4 " style="width:95%;">
        ...
        <%
            ...
            for (MedicalRecord medical : medicalRecord) {
        %>
            <tr>
                <td><%= medical.getRecordId() %></td>
                
                <td><%= medical.getVisitDate() %></td>
                <td><%= medical.getDiagnosis() %></td>
                <td><%= medical.getTreatment() %></td>
                <td><%= medical.getFollowUpDate() %></td>
                <td><%= medical.getAllergic() %></td>
            </tr>
        <%
            }
        %>
