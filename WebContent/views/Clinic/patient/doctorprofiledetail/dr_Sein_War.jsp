...
<head>
    ...
    <title>Dr Sein War War Sein</title>
    <style>
*{
  margin: 0;
    ...
    <div class="container mt-5">
        <div class="row mt-5 " >
            <div class="col-12 col-md-3   p-md-2" style="text-align: center;background-color: rgba(255, 255, 255, 0.491);">
               <div class=" " style="background-color: #b9aeae70;"><img src="${pageContext.request.contextPath}/views/Clinic/patient/img/doctor2G.jpg" width="210px" height="200px"></div> 
            </div>
            <div class="col-12 col-md-4 border text-dark pdoctor" style="background-color: rgba(255, 255, 255, 0.491);">
                <h3 class="text-primary">Dr.Sein War War Sein</h3>
