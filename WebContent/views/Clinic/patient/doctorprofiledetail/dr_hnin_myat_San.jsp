    ...
    <div class="container mt-5">
        <div class="row mt-5 " >
            <div class="col-12 col-md-3   p-md-2" style="text-align: center;background-color: rgba(255, 255, 255, 0.491);">
               <div class=" " style="background-color: #b9aeae70;"><img src="${pageContext.request.contextPath}/views/Clinic/patient/img/d2.png" width="150px" height="200px"></div> 
            </div>
           ...
           <h3 class="text-primary">Dr. Hnin Myat San</h3>
