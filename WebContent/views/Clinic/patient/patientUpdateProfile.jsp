...
<a class="nav-link text-dark address" href="/ClinicManagementSystem/Patient/patientDoctorList">DOCTOR LIST</a>
            ...
            <!-- medicalINof -->
            <li class="nav-item">
             <a class="nav-link text-dark address Active">
              ...
              <li class="nav-item ps-1" >
                <div class="dropdown ">
                    ...
                    <ul class="dropdown-menu ddrop">
                        ...
                        <li><a class="dropdown-item bg-white text-primary" href="${pageContext.request.contextPath}/views/Clinic/patient/patientChangePassword.jsp">Change Password</a></li>
      ...
      <div class="hero-section">
        <div class="" style="width: 100%;">
          <div class="container mt-5  col-md-6 col-lg-5 shadow p-4 mb-5  rounded " >
            ...
            <form action="/ClinicManagementSystem/patientUpdateProfile" method="post" style="font-family: 'Asar';font-size: 17px;">
        <h3 style="text-align: center;">Update Profile</h3>
             ...
             <% 
  				...
  				if(patientId != null){
				      ...
				      if (rs.next()) {
				    	  String name = rs.getString("patient_name");
					        ...
					        String contactno = rs.getString("patient_contact_no");
				%>
                <div class="col-md-6">
                  <label class="form-label" >Patient Name</label>
                  <input type="text" class="form-control bginput" name="patient_name" value="<%= name %>" required pattern="[A-Za-z\s]+$" title="name must be character" autocomplete="off" readonly>
                </div>

                <div class="col-md-6">
                  <label class="form-label">Patient Password</label>
                  <input type="text" class="form-control bginput" name="patient_password" value="<%= password %>" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one lowercase letter, one uppercase letter, and at least 8 characters " autocomplete="off">
                </div>
                
                 <div class="col-md-6">
                  <label class="form-label">Gender</label>
                  <input type="text" class="form-control bginput" name="patient_gender" value="<%= gender%>" required readonly>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control bginput" name="patient_birth_date" value="<%= birthDate %>" required autocomplete="off">
                </div>

                <div class="col-md-6">
	                  <label class="form-label">Patient Address</label>
	                  <input type="text" class="form-control bginput" name="patient_address" value="<%= address %>" required  autocomplete="off">
                </div>
                <div class="col-md-6">
	                  <label class="form-label">Patient Contact No</label>
	                  <input type="text" class="form-control bginput" name="patient_contact_no" value="<%= contactno %>" required pattern="^09[0-9]{9}" autocomplete="off">
                </div>
                <% 
      }
  }
