      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end menulist bBorder" id="collapsibleNavbar" style="padding-right: 70px;">
          <ul class="navbar-nav ">
            ...
            <li class="nav-item ps-1">
              <a class="nav-link text-dark address Active" href="${pageContext.request.contextPath}/views/Clinic/patient/patientDoctorList.jsp">DOCTOR LIST</a>
            </li>
...
<!--SLIde IMG-->
    <div class="p-3 row justify-content-around hero-section "> 
        <% 
            ArrayList<Doctor> doctorList = (ArrayList<Doctor>) request.getAttribute("doctorList");
            if (doctorList != null && !doctorList.isEmpty()) {
                for (Doctor doctor : doctorList) {
        %>
        <div class="card col-md-4 col-sm-12 m-2 p-3 " style="width: 20rem;"  style="background-image: url(../Clinic/doctor/doctorImage/profileslide.jpg)">
            <div style="text-align: center;" >
          <img src="${pageContext.request.contextPath}\uploads\<%=doctor.getDoctor_image()%>" class="card-img-top rounded mx-auto " alt="Doctor" style="width: 200px; height: 200px;" >
        </div>
              <div class="pt-2">
                <h5 class="text-primary float-start "> <%= doctor.getDoctor_name() %> </h5>
                <form action="/ClinicManagementSystem/Patient/DoctorDetail" method="post">
                  <input type="hidden" name="doctorId" value="<%= doctor.getDoctor_id() %>">
                  <button  type="submit" class="float-end border-primary bg-white text-primary px-2 py-1 rounded " >Detail</button>
                </form>
              </div>
