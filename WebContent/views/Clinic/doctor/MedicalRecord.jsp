...
<head>
  ...
  <title>Doctor(Medical Record)</title>
    <style>
     *{
  margin: 0;
...
<body>
  ...
  <div class="hero-section">
    <div class="container  w-50 shadow p-5  bg-body-tertiary rounded mt-1 pt-3" style="margin-bottom:120px;">
      <div class=" text-dark text-center py-2">
        <h2>Medical History</h2>
      </div>
      <form action="/ClinicManagementSystem/medicalRecord" method="post">
       <input type="hidden" name="patient_id" value="${param.patient_id}"> 
        <div class="form-section mt-4 ">
          <div class="mb-3 row d-flex align-items-center">
            <label class="col-sm-3 col-form-label fw-bold">Visit Date</label>
            <div class="col-sm-9">
              <input type="date" class="form-control" name="visit_date"  value="${param.visit_date}">
            </div>
          </div>
          <div class="mb-3 row d-flex align-items-center">
            <label class="col-sm-3 col-form-label fw-bold">Diagnosis</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" name="diagnosis" placeholder="Enter Diagnosis">
            </div>
          </div>
          <div class="mb-3 row d-flex align-items-center">
            <label class="col-sm-3 col-form-label fw-bold">Treatment</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" name="treatment" placeholder="Enter Treatment">
            </div>
          </div>
          <div class="mb-3 row d-flex align-items-center">
            <label class="col-sm-3 col-form-label fw-bold">Follow-up Date</label>
            <div class="col-sm-9">
              <input type="date" class="form-control" name="follow_up_date" placeholder="Enter Follow-up Date">
            </div>
          </div>
          <div class="mb-3 row d-flex align-items-center">
            <label class="col-sm-3 col-form-label fw-bold">Allergic</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" name="allergic" placeholder="Enter Allergic">
            </div>
          </div>
