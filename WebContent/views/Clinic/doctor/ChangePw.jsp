      ...
      <div class="hero-section">
        <div class="" style="width: 100%;">
          <div class="container mt-5 col-md-6 col-lg-4 shadow p-5 mb-5  rounded " >
                ...
                <form action="/ClinicManagementSystem/doctorChangePw" method="post" class=" " style="font-family: 'Asar';font-size: 17px;">
             ...
             <div class="mb-3 col-12 ">
	                  ...
	                  <input type="text" class="form-control bginput" name="doctor_password" value="<%= password %>" required autocomplete="off">
              </div>
            
              <div class="mb-3 col-12">
                <label class="form-label">Change Password</label>
                
                  <input type="password" class="form-control bginput" name="doctor_newpassword" placeholder="Enter change password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one lowercase letter, one uppercase letter, and at least 8 characters">
...
%> 
	  ...
	  var passwordInput = document.getElementById("doctor_password");
