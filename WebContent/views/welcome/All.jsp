...
.menu{
  ...
  background-color:white;
   ...
   .hero-section {
      background: url(${pageContext.request.contextPath}/views/img/slidedoctor.jpg) no-repeat center center;
     ...
     <nav class="navbar navbar-expand-lg  navbar-dark bg-white " style="border-bottom: 2px solid rgba(73, 117, 214, 0.505) ;">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end menulist bBorder" id="collapsibleNavbar" style="padding-right:130px;font-family: 'Asar';font-size: 17px;">
          <ul class="navbar-nav ">
            <li class="nav-item">
              <a class="nav-link text-dark address" href="#">HOME</a>
            </li>
            <!--==================login Modal-->
            <li class="nav-item">
              <a class="nav-link text-dark address" >
                <div type="button"  data-bs-toggle="modal" data-bs-target="#PatientLoginModal" class="w-100" >
                 PATIENT
                </div>
                
                <!-- Modal -->
                <div class="modal fade " id="PatientLoginModal">
                        ...
                        <div class="modal-body" >
                          <div class="row ">
                            <div class="register_right col-12  p-3">
                              <form class="row g-3 mx-2 my-2" action="/ClinicManagementSystem/Patient/login" method="post" style="font-family: 'Asar';font-size: 17px;">
                                  ...
                                  <div class="col-12">
                                    ...
                                    <input type="password" class="form-control"  name="patient_password" placeholder="**********" required  >
                                  </div>
                             
                             <%if(request.getAttribute("loginError")!=null){ %>
                              
                             <div class="col-12 alert alert-danger">  <%= request.getAttribute("loginError") %></div>
                             <%} %>
            ...
            <!-----============CLINIC=============-->
            <li class="nav-item">
                <a class="nav-link text-dark address" href="${pageContext.request.contextPath}/views/Clinic/Home.jsp">CLINIC</a>
              </li>  
            ...
            <!-----============CLINIC=============-->
             ...
             <li class="nav-item"  >
              <a class="nav-link text-dark address" >
                <div type="button"  data-bs-toggle="modal" data-bs-target="#RegisterModal" class="w-100" style="display: none;">
                  REGISTER
                </div>
          ...
          <form action="/ClinicManagementSystem/Patient/register" method="post" style="font-family: 'Asar';font-size: 17px;">
        <h3 style="text-align: center;">Patient  Profile</h3>
        <div class="row p-3">
            <div class="col-md-6 mb-3">
                <label class="form-label">Patient Name</label>
                <input type="text" class="form-control bginput" name="patient_name" placeholder="Enter Patient Name" pattern="[A-Za-z\s]+$" title="name must be character" required autocomplete="off">
            </div>
            ...
            <div class="col-md-6 mb-3">
                <label class="form-label">Password</label>
                <input type="password" class="form-control bginput" name="patient_password" placeholder="*********"  required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number, one lowercase letter, one uppercase letter, and at least 8 characters ">
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control bginput" name="patient_contact_no" placeholder="094556578" pattern="^09[0-9]{9}" required autocomplete="off">
            </div>
