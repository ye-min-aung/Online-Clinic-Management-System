...
/**
 * Servlet implementation class adminReceptionUpdateProfile
 */
@WebServlet("/Admin/adminReceptionUpdateProfile")
public class adminReceptionUpdateProfile extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminReceptionUpdateProfile() {
        super();
