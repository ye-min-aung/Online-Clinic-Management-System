...
/**
 * Servlet implementation class Pro_Khin_khin
 */
@WebServlet("/khinkhin")
public class Pro_Khin_khin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Pro_Khin_khin() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String query="SELECT * FROM Doctor WHERE doctor_id=4";
			...
			while(rs.next()) {
				...
				RequestDispatcher rd=request.getRequestDispatcher("views/Clinic/patient/doctorprofiledetail/Pro_Khin_khin.jsp");
